...
module("example", "write-endpoint", "adapters", "driven", "event", "store", "memory")
module("example", "write-endpoint", "adapters", "driven", "event", "framework", "pulsar", "materialised-view")
