...
module("ddd", "event", "stream", "test", "specification")
module("ddd", "event", "stream", "memory")
module("ddd", "event", "stream", "pulsar")
module("ddd", "event", "framework", "test", "specification")
module("ddd", "event", "framework", "memory")
module("ddd", "event", "framework", "pulsar")
...
module("example", "write-endpoint", "adapters", "driven", "event-sourced")
module("example", "write-endpoint", "starter")
module("example", "write-endpoint", "system", "test", "specification")
module("example", "write-endpoint", "system", "test", "process-based")
module("example", "write-endpoint", "system", "test", "container-based")
