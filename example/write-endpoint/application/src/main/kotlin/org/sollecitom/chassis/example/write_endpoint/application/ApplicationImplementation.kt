...
operator fun Application.Companion.invoke(userWithEmailAddress: suspend (EmailAddress) -> User): Application = ApplicationImplementation(userWithEmailAddress).let(::LoggingApplicationAdapter)