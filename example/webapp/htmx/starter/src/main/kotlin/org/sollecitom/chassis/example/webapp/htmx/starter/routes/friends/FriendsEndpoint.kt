...
import org.http4k.core.noStore
...
class FriendsEndpoint {
    ...
    fun routes() = routes(
            ...
            *friends.map { friend -> "/$friend" bind GET toSuspending { _ -> Response(OK).body(FriendsPages.profile(friend, characteristic.random())).noCache().noStore() } }.toTypedArray()
    )
