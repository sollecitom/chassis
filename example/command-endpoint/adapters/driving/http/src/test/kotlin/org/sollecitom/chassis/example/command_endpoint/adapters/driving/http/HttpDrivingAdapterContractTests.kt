...
import org.sollecitom.chassis.example.command_endpoint.application.user.RegisterUser.V1.Result.Accepted
import org.sollecitom.chassis.example.command_endpoint.application.user.RegisterUser.V1.Result.Rejected.EmailAddressAlreadyInUse
...
// TODO split into 1 spec per endpoint
