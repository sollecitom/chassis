...
private data object RegisterUserV1HttpCommandHandler : HttpCommandHandlerTemplate<RegisterUser.V1, RegisterUser.V1.Result, Access.Unauthenticated>(RegisterUser.V1.type, RegisterUser.V1.Result::class, listOf(Body.jsonObject().map(RegisterUser.V1.serde))) {
...
val RegisterUser.V1.Companion.httpCommandHandler: HttpCommandHandler<RegisterUser.V1, RegisterUser.V1.Result, Access.Unauthenticated> get() = RegisterUserV1HttpCommandHandler