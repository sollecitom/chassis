...
import org.sollecitom.chassis.correlation.core.domain.access.*
...
private class AccessExampleTests : WithCoreGenerators by WithCoreGenerators.testProvider {
    ...
    inner class Authenticated {
        ...
        fun `with given actor and origin`() {
            ...
            val actor = DirectActor(account = Actor.UserAccount(id = newId.ulid(), tenant = Tenant.create()), CredentialsBasedAuthentication(token, session))
