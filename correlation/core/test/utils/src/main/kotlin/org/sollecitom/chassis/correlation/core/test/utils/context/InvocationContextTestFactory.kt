...
): InvocationContext<Access<ULID, Authentication>, ULID> {
...
fun InvocationContext.Companion.authenticated(
    ...
    trace: (Instant) -> Trace<ULID> = { Trace.create(timeNow = timeNow) },
): InvocationContext<Access.Authenticated<ULID, Authentication>, ULID> {
...
fun InvocationContext.Companion.unauthenticated(
    ...
    trace: (Instant) -> Trace<ULID> = { Trace.create(timeNow = timeNow) },
): InvocationContext<Access.Unauthenticated, ULID> {
