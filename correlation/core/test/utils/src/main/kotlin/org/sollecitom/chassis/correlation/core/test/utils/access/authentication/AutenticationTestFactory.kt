...
fun Authentication.Token.Companion.create(validTo: Instant, id: Id = newId.string(), validFrom: Instant? = null): Authentication.Token = Authentication.Token(id = id, validFrom = validFrom, validTo = validTo)

context(WithCoreGenerators)
fun Authentication.Token.Companion.create(id: Id = newId.string(), validTo: Instant? = null, validFrom: Instant): Authentication.Token = Authentication.Token(id = id, validFrom = validFrom, validTo = validTo)

context(WithCoreGenerators)
fun Authentication.Token.Companion.create(validFrom: Instant, validTo: Instant, id: Id = newId.string()): Authentication.Token = Authentication.Token(id = id, validFrom = validFrom, validTo = validTo)

context(WithCoreGenerators)
fun Authentication.Token.Companion.create(timeNow: Instant = clock.now(), id: Id = newId.string(), validFrom: Instant? = timeNow - 5.minutes, validTo: Instant? = timeNow + 25.minutes): Authentication.Token = Authentication.Token(id = id, validFrom = validFrom, validTo = validTo)
