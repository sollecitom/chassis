...
sealed interface Access<out ID : Id<ID>, out AUTHENTICATION : Authentication> {
    ...
    data class Authenticated<out ID : Id<ID>, out AUTHENTICATION : Authentication>(val actor: Actor<ID, AUTHENTICATION>, override val origin: Origin, override val authorization: AuthorizationPrincipal) : Access<ID, AUTHENTICATION> {
